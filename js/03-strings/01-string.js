// Combing string together is called concatenation it can be used with a plus(+)
// type coercion when doing String + number it will be a string.
...
console.log("My name is: " + "Kenzo");

// At a restaurant, you order 1 coffee ($5) and 1 bagel ($3). Using math, calculate the total cost, and using concatenation, create the text: 'Total cost: $___' (replace ___ with the total you calculated).
